...
export function Sources({ onNavigate }) {
  return (
    <div className='space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-700'>
      <header>
        <h1 className='text-4xl font-bold tracking-tight'>Source Manager</h1>
        <p className='text-zinc-500 font-mono text-xs mt-1'>SYSTEM_NODE :: SOURCES_v1.0.4</p>
      </header>
      ...
      <div className='lens-glass p-8 rounded-2xl border border-white/5 min-h-[400px] flex flex-col items-center justify-center text-center'>
        ...
        <p className='text-zinc-400 max-w-md'>Local forensic analysis is ready for the Sources environment. No data has left your Intel iMac.</p>
